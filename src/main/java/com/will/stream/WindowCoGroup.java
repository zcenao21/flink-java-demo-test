...
public class WindowCoGroup {
	...
	public static void main(String[] args) throws Exception {
		...
		result1.coGroup(result2)
				.where(v->v.f0).equalTo(v->v.f0)
				.window(ProcessingTimeSessionWindows.withGap(Time.seconds(3)))
				.apply(new CoGroupFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, Object>() {

					@Override
					public void coGroup(Iterable<Tuple2<String, Integer>> iterable, Iterable<Tuple2<String, Integer>> iterable1, Collector<Object> collector) throws Exception {
						int sum =0;
						...
						sb.append("  second:");
						for(Tuple2<String,Integer> t1:iterable1){
							sum+=t1.f1;
							sb.append(t1.f0+" ");
						}
						collector.collect(new Tuple2<>(sb.toString(),sum));
					}
				})
				.print();
